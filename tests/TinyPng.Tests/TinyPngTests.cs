...
public class TinyPngTests
{
    ...
    public async Task CompressionFromUrl()
    {
        ...
        var result = await pngx.Compress(new Uri("https://sample.com/image.jpg"));
    ...
    public void CompressionShouldThrowIfNoUrlToFile()
    {
        ...
        Assert.ThrowsAsync<ArgumentNullException>(async () => await pngx.Compress(new Uri(string.Empty)));
    }
